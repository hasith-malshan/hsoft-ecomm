        ...
        <div class="row">
            ...
            <div class="col-12" id="GFG">
                <div class="row">
                    ...
                    <?php $invoiceS = Database::s("SELECT * FROM `invoice` WHERE `order_id`='" . $oid . "'");
                    $invoiceSNr = $invoiceS->num_rows;
                    $invoiceSD = $invoiceS->fetch_assoc();

                    $productS = Database::s("SELECT * FROM `product` WHERE `id`='" . $invoiceSD["product_id"] . "' ;");
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr style="height: 70px;">
                                    ...
                                    <td><a href="#" class="fs-6"><?php echo $invoiceSD["order_id"]; ?></a><br />
                                        <a href="#" class="fs-6"><?php echo $productSD["title"]; ?></a>
                                    </td>
                                    <td class="fs-6 text-end pt-3 bg-primary">Rs <?php echo $productSD["price"]; ?>.00</a></td>
                                    <td class="fs-6 text-end pt-3"><?php echo $invoiceSD["qty"]; ?></td>
                                    <td class="fs-6 text-end pt-3 bg-primary text-white"> <span class="h2"> Rs. <?php echo $invoiceSD["total"]; ?>.00</span> <br>
                                    <?php echo "(".$productSD["price"]."X".$invoiceSD["qty"].") + ".$invoiceSD["total"] - $productSD["price"]*$invoiceSD["qty"] ?></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="2" class="fs-5 text-end">Rs <?php echo $invoiceSD["total"]; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="border-0 "></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="fs-4 text-end border-primary text-primary">Rs. <?php echo $invoiceSD["total"]; ?>.00</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
